...
import { DEFAULT_SLIDE_STYLE, slideStyleSchema } from './data/slide-style';

// Top-level schema for a Watchboard composition. Only `slideStyle` is
// fully typed for the Studio's interactive editor. The other props are
// passed through as `any` so we don't have to maintain a shadow type for
// the (large) BreakingData and GeoFeature[] types.
