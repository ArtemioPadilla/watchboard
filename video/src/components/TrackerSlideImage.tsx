...
interface TrackerSlideImageProps {
...
export const TrackerSlideImage: React.FC<TrackerSlideImageProps> = ({
  tracker,
  accentColor,
}) => {
    ...
    >
      ...
      <div
        style={{
          ...
          bottom: 0,
          background:
            'linear-gradient(to bottom, rgba(10,11,14,0) 30%, rgba(10,11,14,0.85) 70%)',
        }}
      />
